                ...
                script{
                    ...
                    if(where == "bj01"){
                        ...
                        withCredentials([usernamePassword(credentialsId: 'aliyun',
                            ...
                            sh "docker login -u ${ali_user} -p ${ali_pwd} registry.cn-beijing.aliyuncs.com"
                            sh "docker tag devops-demo registry.cn-beijing.aliyuncs.com/grady/devops-demo:${APP_VER}"
                            sh "docker push registry.cn-beijing.aliyuncs.com/grady/devops-demo:${APP_VER}"
                         }
